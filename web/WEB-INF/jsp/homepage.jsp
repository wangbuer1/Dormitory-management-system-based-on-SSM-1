...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="www.baidu.com">宿舍管理系统</a></div>
    <div class="left_open">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <c:if test="${sessionScope.ad.a_power==1}"><a href="javascript:;">管理员：${sessionScope.ad.a_username}</c:if>  <c:if test="${sessionScope.ad.a_power==2}"><a href="javascript:;">宿管：${sessionScope.ad.a_username}</a></c:if>
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
                <dd><a onclick="x_admin_show('切换帐号','loginOut')">切换帐号</a></dd>
                <dd><a href="/loginOut">退出</a></dd>
            </dl>
        </li>
        <li class="layui-nav-item to-index"><a href="/loginOut">退出系统</a></li>
    </ul>
...
<!-- 底部开始 -->
<div class="footer">
    <div class="copyright">Copyright ©公众号：程序员王不二</div>
</div>
<!-- 底部结束 -->
